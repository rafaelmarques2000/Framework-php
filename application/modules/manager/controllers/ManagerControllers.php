...
class ManagerControllers extends Controller{
      ...
      public function CreateController(){
         ...
         try{
          ...
          if(file_exists("../application/modules/".$data['module_list']."/controllers/".$data['name_controller']."Controller.php")){
            ...
            $controllerFile = fopen("../application/modules/".$data['module_list']."/controllers/".$data['name_controller']."Controller.php",'w+');
